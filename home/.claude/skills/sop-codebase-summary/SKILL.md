---
name: sop-codebase-summary
description: Analyze a codebase and generate comprehensive documentation including architecture, components, interfaces, and an optional consolidated AGENTS.md.
