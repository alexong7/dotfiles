---
name: sop-pdd
description: Transform a rough idea into a detailed design document with implementation plan using Prompt-Driven Development methodology.
...
- You MUST prompt the user to add all project files to context using the command: `/context add {project_dir}/**/*.md`
